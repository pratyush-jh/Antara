...
const Participation = ({ event }) => {
     ...
     const { date, description, start_at, ends_at, rounds, paid_event, minimum_size, maximum_size , society , tag_line, title, team_fee , upi_id, venue , image_url, inidiviual_fees } = event;
     const {fetchApi} = Api();
     const initialValue = {
          teamName: '',
          numberOfMembers: '',
                         ...
                         <Form>
                              ...
                              step === 1 ? (
                                   <div className="flex flex-col gap-5 items-center justify-center">
                                        ...
                                        {
                                             paid_event ? (
                                                 step==1 &&  <button onClick={() => setStep(2)} className=" font-semibold bg-gray-800 text-white pt-2 pb-2 pl-4 pr-4 rounded-lg">
                                                       Pay Team Fee
                                                  </button>
                                             ) : (
