...
// // Note -  New Component with tailwindcss
...
const Home = () => {
  return (
    <>
      <img src={img1} className="w-full h-150"></img>
      <div
        className="absolute w-2/5 h-75 bg-white bg-opacity-30 text-center mt-[-112.5rem] ml-30 z-10 text-9xl font-bold text-white p-3"
      >
        <p>T H E</p>
        <p>A N N U A L</p>
        <p>C U L T U R A L</p>
      ...
      <div
        className="w-full bg-gradient-to-r from-black via-red-800 to-black p-20"
      >
        <div className="w-9/10 mx-auto p-10 bg-gradient-to-r from-red-800 via-black to-red-800 border-2 border-white rounded-lg">
          <p className="text-white text-lg font-cursive">Antara: The Annual Cultural Fest of P.G.D.A.V. College, University of Delhi" is one of the most eagerly awaited cultural events in the college's calendar...</p>
        </div>
        <h1 className="text-center mt-20 mb-10 text-5xl text-white">FAQS</h1>
        <div id='faqs' className="w-9/10 mx-auto p-10 bg-white rounded-lg">
          {/* Accordion components go here */}
        </div>
        <div className="w-3/5 h-75 bg-purple-800 mt-25 rounded-r-full flex items-center text-center">
          <h1 className="text-white p-5 text-5xl w-full">Support Us</h1>
          <div className="w-7/10 mx-auto flex justify-between">
